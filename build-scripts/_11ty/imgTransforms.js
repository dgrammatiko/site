...
module.exports = function (value, outputPath) {
    if (outputPath.endsWith('.html')) {
        ...
        if (![`${root}/${siteDest}/index-top.html`, `${root}/${siteDest}/index-bottom.html`, `${root}/${siteDest}/offline.html`].includes(outputPath) && !Fs.existsSync(outputPath.replace('/index.html', ''))) {
        ...
        if ([`${root}/${siteDest}/index-top.html`, `${root}/${siteDest}/index-bottom.html`].includes(outputPath)) {
            return value;
        }
